...
class TestGetTodos:
    ...
    def test_search_functionality(self, test_db):
        ...
        TodoService.create_todo(test_db, {"title": "Important Task", "description": "Very important"})
        TodoService.create_todo(test_db, {"title": "Normal Task", "description": "Regular task"})
